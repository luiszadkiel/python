...
while opcion != 5:
        print('Opciones: ')
        print('1. Lista usuario')
        print('2. Agragar usuario')
        print('3. Modificar usuario' )
        print('4. Eliminar usuario')
        print('5. salir')
        opcion = int(input('Escribe una opcion entre (1-5): '))
        if opcion == 1:
            ...
            usuario = Usuario(nombre= username_var, password= password_var)
